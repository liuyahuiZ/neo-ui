...
export function getDateTimeStr(tm) {
  const d = tm ? new Date(tm) : new Date();
  let year = d.getFullYear();
  let month = d.getMonth() + 1 < 10 ? "0" + (d.getMonth() + 1) : d.getMonth() + 1;
  let day = d.getDate() < 10 ? "0" + d.getDate() : d.getDate();
  let hour =  d.getHours() + 1 < 10 ? "0" + d.getHours() : d.getHours() ;
  let minute = d.getMinutes() + 1 < 10 ? "0" + d.getMinutes() : d.getMinutes() ;
  let second = d.getSeconds() + 1 < 10 ? "0" + d.getSeconds() : d.getSeconds() ; 
  let YMDHMS = year + month + day + hour + minute + second;
