...
import { Buttons, Container, Toaster } from '../../Components';
...
export default class SearchPart extends Component {
  ...
  render() {
    const { conditions, title, buttonsContainerStyle } = this.props;
    return (
          <div style={styles.searchContainer}>
                ...
                >
                  ...
                  </span>
                  {
                    (condition.items || [condition]).map(item =>
                      <div key={item.key} style={styles.keys}>
                        {
                          this.genInput(item)
                        }
            ...
            <div
              style={arrayUtils.merge([styles.buttons, buttonsContainerStyle])}
            >
            <Buttons
              text="查询"
              type={'primary'}
