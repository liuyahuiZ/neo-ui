...
class Row extends Component {
  ...
  render() {
    const { direction, justify, align, style, gutter, className, content, dataKey } = this.props;
    ...
    // }
    return (
      <div className={ClassName} style={arrayUtils.merge([style, gutterStyle])} onClick={this.handleClick} data-keynum={dataKey}>
        {Children}
      </div>
    );
  }
